...
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \33[97;1m HOSSAIN  ♚   \033[38;5;46m               ▇▎ 

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mMD HOSSAIN  ( 𝐌 )  \033[38;5;46m           ▇▎  

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \033[38;5;196m: \033[1;92m+𝟖𝟖𝟎𝟏𝟑24387832\033[38;5;46m                  ▇▎

\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/mdhussain343\033[38;5;46m ▇▎
...
def admin():
	...
	if bal =='1':
		...
		os.system('xdg-open https://wa.me/+8801324387832');time.sleep(1)

		admin()

	if bal =='2':

		os.system('xdg-open https://www.facebook.com/keray.link.copy.koros.kan');time.sleep(1)

		admin()

	if bal =='3':

		os.system('xdg-open https://github.com/mdhussain343');time.sleep(1)
...
def hoga_check():
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/mdhussain343/RANDOM/main/Apruval.txt").text 
...
def a(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mHOSSAIN \033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
        ...
        sys.stdout.write(f'\r\033[m[HOSSAIN ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),

       # sys.stdout.write(f" \r{R} [{B}HOSSAIN {R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
